// -----------------------------------------------------------
//  [*] Tests — chatkit: menu registry, message kinds, link kinds
//
...
import { buildMenuRows, defaultLabels, floatingDayFor, linkify, messageKind, type KitMessage } from '@knf/chatkit';
