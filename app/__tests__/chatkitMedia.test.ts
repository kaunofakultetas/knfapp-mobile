// -----------------------------------------------------------
//  [*] Tests — chatkit media helpers
//
//  The pure sizing and formatting rules every media bubble
//  agrees on: fitMedia (Stream's single-image fit with Flyer's
//  ratio clamps), the box per viewport, the duration / size
//  formatters, the reply snippet per kind and the file glyph.
// -----------------------------------------------------------

import { DEFAULT_ASPECT, MAX_ASPECT, MIN_ASPECT, fitMedia, formatBytes, formatDuration, mediaBoxFor, messageKind, replySnippet, defaultLabels, fileGlyph, type KitMessage } from '@knf/chatkit';
