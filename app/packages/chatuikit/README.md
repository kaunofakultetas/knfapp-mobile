...
| Memes | a **MemePicker panel** (search + grid of animated GIFs and static images + a push tile) fed by the host's own library — no GIF SaaS — with the composer's MEME badge toggling it |
