// -----------------------------------------------------------
//  [*] useChatKitLabels — the kit's strings from our catalog
//
//  The app's half of the chatkit labels contract: every
//  KitLabels field mapped onto the `chat.*` (and two `common.*`)
//  keys of the i18n catalog, memoised per language. Handed to
//  ChatKitProvider by ChatKitHost; the kit itself never calls
//  t(). Adding a string to the kit means adding a key here and
//  in both catalogs — the labels test walks every field.
//
//  Used by:
//    - components/chat/ChatKitHost.tsx
// -----------------------------------------------------------

import { useMemo } from 'react';
import { useTranslation } from 'react-i18next';

import type { KitLabels } from '@knf/chatkit';


export default function useChatKitLabels(): KitLabels {
