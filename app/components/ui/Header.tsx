...
export default function Header({ title, right, left, style, ...props }: HeaderProps) {
  ...
  return (
    <SafeAreaView edges={['top']} style={{ backgroundColor: '#7B003F' }}>
      <View className="bg-primary px-lg flex-row items-center" style={[{ paddingVertical: 14 }, style]} {...props}>
        <Pressable
        ...
        <Text className="text-white text-xl font-raleway-bold flex-1">{title}</Text>
